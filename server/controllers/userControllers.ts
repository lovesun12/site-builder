...
export const createUserProject = async (req: Request, res: Response) => {
    ...
    try{
        ...
        //update user to increase creation
        ...
        console.log("AI RESPONSE:", codeGenerationResponse);
...
//controller function to toggle publish status of a project
...
export const purchaseCredits = async (req: Request, res: Response) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            expires_at: Math.floor(Date.now()/1000) + 30*60 //30 minutes from now it will expire
        });

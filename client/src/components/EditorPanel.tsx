  ...
  return (
    ...
    <div className='space-y-4 text-black'>
        ...
        <div>
            ...
            <input type='text' value={values.className || ''} onChange={(e)=>handleChange('className',e.target.value)} className='w-full text-sm p-2 border border-gray-400 rounded-md focus:ring-indigo-500 outline-none focus:ring-2'/>
        </div>
        <div className='grid grid-cols-2 gap-3'>
            <div>
                ...
                className='w-full text-sm p-2  rounded-md focus:ring-indigo-500 border border-gray-400 outline-none focus:ring-2'/>
        ...
        <div className='grid grid-cols-2 gap-3'>
            ...
            <div>
                ...
                <div className='flex items-center gap-2 border border-gray-400 rounded-md p-1'>
                    <input type='color' value={values.styles.color==='rgba(0, 0, 0, 0)' ? '#ffffff' :values.styles.backgroundColor} 
